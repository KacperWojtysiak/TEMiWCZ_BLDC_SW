...
#define PID_TORQUE_KI_DEFAULT               882
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 2703
#define PID_FLUX_KI_DEFAULT                 882
...
#define PID_SPEED_KI_DEFAULT                372/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define PHASE4_FINAL_SPEED_UNIT             (1000*SPEED_UNIT/U_RPM)
...
#define NB_CONSECUTIVE_TESTS                5 /* corresponding to former
                                                 NB_CONSECUTIVE_TESTS / (TF_REGULATION_RATE / MEDIUM_FREQUENCY_TASK_RATE) */
#define SPEED_BAND_UPPER_LIMIT              24 /*!< It expresses how much estimated speed can exceed forced stator electrical
